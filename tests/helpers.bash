...
RASDAEMON=${FIXTURE_DIR}/bin/rasdaemon
RAS_MC_CTL=${FIXTURE_DIR}/bin/ras-mc-ctl
MCELOG_PATH=${FIXTURE_DIR}/dev/mcelog
DEV_ROOT=${FIXTURE_DIR}/dev
NVME_CMD=${FIXTURE_DIR}/bin/nvme
LVS_CMD=${FIXTURE_DIR}/bin/lvs
CHRONYC=${FIXTURE_DIR}/bin/chronyc
TIMEDATECTL=${FIXTURE_DIR}/bin/timedatectl
